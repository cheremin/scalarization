 ...
 * leads to "merge point" issue is in play (see {@linkplain ru.cheremin.scalarization.lab.plain.ControlFlowScenario}.
 * <p/>
 ...
 * EnumSetIterator which confuses scalarization. The story is the same as in {@linkplain ru.cheremin.scalarization.lab.collections.ArrayAsListScenario}:
